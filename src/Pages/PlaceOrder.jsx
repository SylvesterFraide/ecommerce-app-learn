        ...
        <div className="mt-12">
          ...
          <div className="flex gap-1 flex-col lg:flex-row">
            <div className="flex items-center gap-1 p-2 px-3 cursor-pointer">
              <p
                className={`${
                  paymentMethod === "mpesa" ? "bg-green-400" : ""
            ...
            {/* <div className="flex items-center gap-1 p-2 px-3 cursor-pointer">
              <p
                className={`${
                  paymentMethod === "sasapay" ? "bg-green-400" : ""
                } min-w-3.5 h-3.5 border rounded-full`}
            ...
            <div className="flex items-center gap-1 p-2 px-3 cursor-pointer">
              ...
              ></p>
              <p className="text-gray-500 text-sm medium mx-4">
                CASH ON DELIVERY
              </p>
            </div>
          </div>
          <div className="w-full text-end mt-8">
            <button
              ...
              className="bg-black text-white py-3 px-16 rounded text-sm "
            >
              PLACE ORDER
            </button>
          </div>
